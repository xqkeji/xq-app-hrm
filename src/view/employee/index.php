...
<head>
  ...
  <meta name="description" content="<?=xq_p('xq-app-mini-name','新齐').xq_p('xq-app-name','企业人事管理系统')?>">
  <meta name="author" content="XqKeji">
  <title><?=xq_p('xq-app-mini-name','新齐').xq_p('xq-app-name','企业人事管理系统')?></title>
	...
	<div id="xq-header" class="row no-gutters bg-success bg-gradient fixed-top align-items-center">
		...
		<div class="col-2 text-center">
			<a target="_blank" href="<?=xq_p('xq-app-site-url','https://www.xqkeji.cn/')?>" class="brand-link text-decoration-none" >
				...
				<span class="brand-text font-weight-light xq-desc"><?=xq_p('xq-app-name','企业人事管理系统')?></span>
			</a>
		</div>
		<!--右边-->
		<div class="col-10">
				...
				<div class="col-2 d-flex justify-content-end pe-3">
					<div id="xq-top-menu" class="btn-group">
						<div class="dropdown">
							...
							<?php 
							$auth=$this->auth->getRealAuth('employee');
							echo trim($auth['name']);
							?> 
							</button>
							<ul class="dropdown-menu" aria-labelledby="xqkeji-dropdowmenu">
							  <li>
								  <a class="dropdown-item xq-logout" href="<?=xq_url('employee/logout')?>">退出登录</a>
							  </li>
							</ul>
						</div>
					</div>
        ...
        <div class="col-2 p-0 bg-dark" id="xq-sidebar">
            ...
            <nav id="xqkeji_admin_menu">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a href="<?=xq_url('employee/notice')?>" id="notice" class="nav-link bg-primary"><i class="bi bi-bell"></i><p>人事公告</p></a>
                </li>
                <li class="nav-item">
                  <a href="<?=xq_url('employee/info')?>" id="info" class="nav-link bg-dark "><i class="bi bi-info-square"></i><p>个人信息</p></a>
                </li>
                <li class="nav-item">
                  <a href="<?=xq_url('employee_attend/admin')?>" id="attend" class="nav-link bg-dark "><i class="bi bi-record-circle"></i><p>签到记录</p></a>
                </li>
				<li class="nav-item">
                  <a href="<?=xq_url('employee/wages')?>" id="wages" class="nav-link bg-dark "><i class="bi bi-briefcase"></i><p>工资记录</p></a>
                </li>
                <li class="nav-item">
                  <a href="<?=xq_url('employee/change_password')?>" id="change_password" class="nav-link bg-dark "><i class="bi bi-key-fill"></i><p>修改密码</p></a>
                </li>
                <li class="nav-item">
                  <a href="<?=xq_url('employee/logout')?>" id="logout" class="nav-link bg-dark xq-logout"><i class="bi bi-sign-turn-left-fill"></i><p>退出登录</p></a>
                </li>
              </ul>
            </nav>
        ...
        <div class="col-10 p-0" id="xq-content">
            ...
            <div class="tab-content" id="xq-tab-content">
                ...
                <div class="tab-pane active" id="notice-tab-content" role="tabpanel" aria-labelledby="notice-tab" >
                    <iframe src="<?=xq_url('employee/notice')?>" width="100%" frameborder="no" border="0" marginwidth="0" marginheight="0" ></iframe>
                </div>
                <!--欢迎页面结束-->
            </div>
            <!--Tab标签页面集合结束-->
...
<footer id="xq-footer" class="row no-gutters fixed-bottom bg-light border">
	<div class="col-8 ps-4">
		<strong>Copyright &copy; <?=date('Y')?> &nbsp; &nbsp;<a href="<?=xq_p('xq-app-site-url','https://www.xqkeji.cn/')?>"><?=xq_p('xq-app-mini-name','新齐').xq_p('xq-app-name','企业人事管理系统')?></a>. &nbsp; &nbsp;</strong>
		All rights reserved.
	</div>
